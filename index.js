...
let book1 = new Book("Effective TypeScript: 62 Specific Ways to Improve Your TypeScript", "Dan Vanderkam");
console.log(Book.numberOfBooks);
let book2 = new Book("Programming TypeScript: Making Your JavaScript Applications Scale", "Boris Cherny");
book1.displayDetails();
book2.displayDetails();
console.log(book2.bookNumber);
class Ebook extends Book {
    filesize;
    constructor(name, author, filesize) {
        super(name, author);
...
let eBook1 = new Ebook("Learning TypeScript 2.x", "Remo H. Jansen", "Approximately 18 MB");
let eBook2 = new Ebook("TypeScript Essentials", "Christopher Nance", "Approximately 7 MB");
